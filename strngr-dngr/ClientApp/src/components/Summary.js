...
const CriminalCheckSummary = (props) => {
  ...
  return (
    <div className="box">
      ...
      <div className="body">
          {offenderLookupResults.firstname}{offenderLookupResults.lastname ? ` ${offenderLookupResults.lastname}` : ""}, born {offenderLookupResults.birth_year} committed the following crime: {offenderLookupResults.crime_description}.  This crime occurred in {offenderLookupResults.city}.
      </div>
    </div>
  )
}
        ...
        <div className="box">
            ...
            <div className="body">
                ...
                <div className="section">
                    ...
                    {primary_phone_checks.subscriber && `  The phone number ${matchFound(primary_phone_checks.match_to_name) ? "indeed" : ""} belongs to ${primary_phone_checks.subscriber.name}${primary_phone_checks.subscriber.age_range && `, aged between ${primary_phone_checks.subscriber.age_range.from} and ${primary_phone_checks.subscriber.age_range.to}.`}`}
                    </div>
                </div>
                ...
                <div className="section">
                    ...
                    {primary_email_address_checks.registered_owner && `  The email ${matchFound(primary_email_address_checks.match_to_name) ? "indeed" : ""} belongs to ${primary_email_address_checks.registered_owner.name}`}
                    </div>
                </div>
